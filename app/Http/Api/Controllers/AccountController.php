...
class AccountController extends Controller
{
    ...
    public function registerAction()
    {
        ...
        $authInfo = $service->register();

        return $this->jsonSuccess(['token' => $authInfo['token']]);
    }
    ...
    public function loginByPasswordAction()
    {
        ...
        $authInfo = $service->loginByPassword();
    ...
    public function loginByVerifyAction()
    {
        ...
        $authInfo = $service->loginByVerify();

        return $this->jsonSuccess(['token' => $authInfo['token']]);
    }

    /**
     * @Post("/logout", name="api.account.logout")
     */
