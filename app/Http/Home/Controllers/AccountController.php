...
use App\Services\Logic\Account\IdentityProvider as IdentityProviderService;
...
class AccountController extends Controller
{
    ...
    public function registerAction()
    {
        ...
        $identityProvider = $service->handle();

        $this->seo->prependTitle('用户注册');

        $this->view->setVar('local_identity', $identityProvider['local']);
