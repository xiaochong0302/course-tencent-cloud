        ...
        <div class="info">
            ...
            <div class="meta">
                {% if course.market_price == 0 %}
                    ...
                    <span class="user">{{ course.user_count|human_number }} 人报名</span>
                {% elseif course.vip_price == 0 %}
                    <span class="free">会员免费</span>
                    <span class="lesson">{{ course.lesson_count|human_number }} 节课</span>
                    <span class="user">{{ course.user_count|human_number }} 人购买</span>
