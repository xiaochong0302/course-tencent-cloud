<form class="layui-form account-form" method="POST" action="{{ action_url }}">
    <div class="layui-form-item">
        <div class="layui-input-wrap">
            ...
            <input id="cv-phone" class="layui-input" type="text" name="phone" placeholder="手机" lay-verify="required|phone">
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-wrap">
            <div class="layui-input-prefix"><i class="layui-icon layui-icon-password"></i></div>
            <input class="layui-input" type="password" name="new_password" placeholder="新密码" lay-affix="eye" lay-verify="required">
        </div>
    </div>
    <div class="layui-form-item">
