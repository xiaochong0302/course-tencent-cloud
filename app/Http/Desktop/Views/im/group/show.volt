...
{% block content %}
    ...
    {% set apply_group_url = '' %}
    {% set users_url = url({'for':'desktop.group.users','id':group.id}) %}
    {% set active_users_url = url({'for':'desktop.group.active_users','id':group.id}) %}

    <div class="breadcrumb">
        <span class="layui-breadcrumb">
            <a href="/">首页</a>
            <a href="{{ url({'for':'desktop.group.list'}) }}">群组</a>
...
{% block include_js %}
    ...
    {{ js_include('desktop/js/im.group.show.js') }}
