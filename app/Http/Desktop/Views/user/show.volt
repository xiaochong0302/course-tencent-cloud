...
{% block content %}
    ...
    {% set courses_url = url({'for':'desktop.user.courses','id':user.id}) %}
    {% set favorites_url = url({'for':'desktop.user.favorites','id':user.id}) %}
    {% set friends_url = url({'for':'desktop.user.friends','id':user.id}) %}
    {% set groups_url = url({'for':'desktop.user.groups','id':user.id}) %}
