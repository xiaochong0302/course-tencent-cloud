    ...
    <form class="layui-form kg-form" method="GET" action="{{ action_url }}">
        ...
        <div class="layui-form-item" id="reg-time-range">
            ...
            <div class="layui-input-inline">
                <input class="layui-input" id="reg-start-time" type="text" name="create_time[]">
            </div>
            <div class="layui-form-mid"> -</div>
            <div class="layui-input-inline">
                <input class="layui-input" id="reg-end-time" type="text" name="create_time[]">
            </div>
        </div>
        <div class="layui-form-item" id="active-time-range">
            <label class="layui-form-label">活跃时间</label>
            <div class="layui-input-inline">
                <input class="layui-input" id="active-start-time" type="text" name="active_time[]">
            </div>
            <div class="layui-form-mid"> -</div>
            <div class="layui-input-inline">
                <input class="layui-input" id="active-end-time" type="text" name="active_time[]">
            </div>
        </div>
        <div class="layui-form-item">
