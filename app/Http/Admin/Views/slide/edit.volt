...
{% block content %}
    ...
    {% set target_info = objectify(slide.target_info) %}
    ...
    <form class="layui-form kg-form" method="POST" action="{{ url({'for':'admin.slide.update','id':slide.id}) }}">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <div class="layui-form-mid">{{ target_type(slide.target_type) }}</div>
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">目标信息</label>
            <div class="layui-input-block">
                <div class="layui-form-mid">{{ target_info(target_info) }}</div>
            </div>
        </div>
        <div class="layui-form-item">
