...
{% block content %}
    ...
    <form class="layui-form kg-form" method="POST" action="{{ url({'for':'admin.slide.create'}) }}">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                {% for value,title in target_types %}
                    <input type="radio" name="target_type" value="{{ value }}" title="{{ title }}" lay-filter="target_type">
                {% endfor %}
            </div>
        </div>
        ...
        <div id="block-6" class="block" style="display:none;">
            <div class="layui-form-item">
        ...
        <div id="block-7" class="block" style="display:none;">
            <div class="layui-form-item">
