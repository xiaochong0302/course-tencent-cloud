...
class Course extends Model
{
     ...
     * 模型
     */
    const int MODEL_VOD = 1; // 点播
    const int MODEL_LIVE = 2; // 直播
    const int MODEL_READ = 3; // 图文
    const int MODEL_OFFLINE = 4; // 面授
    const int MODEL_DOC = 5; // 文档

    /**
     * 级别
     */
    const int LEVEL_ENTRY = 1; // 入门
    const int LEVEL_JUNIOR = 2; // 初级
    const int LEVEL_MEDIUM = 3; // 中级
    const int LEVEL_SENIOR = 4; // 高级
     ...
     * @var float
     */
    public float $market_price = 0.00;
     ...
     * @var int
     */
    public int $model = self::MODEL_VOD;
