...
class EditorStorage extends Storage
{
    ...
    protected function handleBase64Image(string $content): string
    {
    ...
    protected function handleRemoteImage(string $content): string
    {
    ...
    protected function uploadBase64Image(string $encodeContent, string $extension): string
    {
    ...
    protected function uploadRemoteImage(string $remoteUrl): string
    {
     ...
     * @return string
     */
    protected function getImageExtension(string $imageUrl): string
    {
