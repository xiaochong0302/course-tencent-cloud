...
class ChapterLike extends LogicService
{
    ...
    protected function incrChapterLikeCount(ChapterModel $chapter): void
    {
    ...
    protected function decrChapterLikeCount(ChapterModel $chapter): void
    {
    ...
    protected function incrUserDailyChapterLikeCount(UserModel $user): void
    {
