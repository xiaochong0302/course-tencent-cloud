...
class ChapterList extends LogicService
{
    ...
    protected function handleGuestUserChapters(array $chapters, CourseModel $course): array
    {
        foreach ($chapters as &$chapter) {
            foreach ($chapter['children'] as &$lesson) {
                $lesson['me'] = [
    ...
    protected function getLearningMappings(int $courseId, int $userId, int $planId): array
    {
