...
class Account extends Validator
{
    ...
    public function checkAccount(string|int $name): AccountModel
    {
        $account = null;
    ...
    public function checkLoginName(string $name): void
    {
    ...
    public function checkIfPhoneTaken(string $phone): void
    {
        $accountRepo = new AccountRepo();
    ...
    public function checkRegisterStatus(string $account): void
    {
        $local = $this->getSettings('security.register');
    ...
    public function checkVerifyLogin(string $name, string $code): UserModel
    {
    ...
    public function checkUserLogin(string $name, string $password): UserModel
    {
        $this->checkLoginName($name);
    ...
    public function checkAdminLogin(string $name, string $password): UserModel
    {
