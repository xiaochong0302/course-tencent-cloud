...
class Client extends Validator
{
    ...
    public function checkH5Platform(string $platform): int
    {
    ...
    public function checkMpPlatform(string $platform): int
    {
        $platform = strtoupper($platform);
    ...
    public function checkAppPlatform(string $platform): int
    {
        $platform = strtoupper($platform);
