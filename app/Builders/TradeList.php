...
class TradeList extends Builder
{
    ...
    public function handleOrders(array $trades): array
    {
    ...
    public function handleUsers(array $trades): array
    {
    ...
    public function getOrders(array $trades): array
    {
    ...
    public function getUsers(array $trades): array
    {
