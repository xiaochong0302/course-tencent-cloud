layui.define(['jquery', 'layer'], function (exports) {
    ...
    helper.qzoneShare = function (title, url, pic) {
    ...
    helper.doubanShare = function (title, url, pic) {
        var shareUrl = 'https://www.douban.com/share/service?';
        shareUrl += 'name=' + encodeURIComponent(title || document.title);
        shareUrl += '&href=' + encodeURIComponent(url || document.location);
        shareUrl += '&image=' + encodeURIComponent(pic || '');
        window.open(shareUrl, '_blank');
    };
